...
require_once BODYENERGY_WORDPRESS_PATH . 'includes/memberships-public-policy.php';
...
require_once BODYENERGY_WORDPRESS_PATH . 'includes/services-theme-cleanup.php';
