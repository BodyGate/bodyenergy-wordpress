...
/**
 * Restituisce un badge di stato sicuro per la pagina amministrativa.
 */
...
/**
 * Mostra la dashboard tecnica, esclusivamente in lettura.
 */
function bodyenergy_render_admin_page()
{
    ...
    <div class="wrap bodyenergy-admin">
        <div class="bodyenergy-hero">
            <div>
                ...
                <p class="bodyenergy-subtitle">
                    Stato tecnico del sito WordPress e preparazione del collegamento sicuro con BodyGate.
                </p>
            </div>
            ...
            <div class="bodyenergy-service-list">
                <div class="bodyenergy-service">
                    <div>
                        ...
                        <span>Shop, ordini e pagamenti WordPress</span>
                    </div>
                ...
                <div class="bodyenergy-service">
                    <div>
                        ...
                        <span>Gestione grafica delle pagine pubbliche</span>
                    </div>
                ...
                <div class="bodyenergy-service">
                    <div>
                        <strong>BodyGate API</strong>
                        <span>Lead, prenotazioni e area clienti saranno collegati tramite API protette</span>
                    </div>
    ...
    <style>
        ...
        .bodyenergy-panel__note {
            color: #8f8f99;
            font-size: 12px;
        }

        .bodyenergy-service-list {
            margin-top: 24px;
        ...
        .bodyenergy-service strong,
        .bodyenergy-service span {
            display: block;
        }
        ...
        .bodyenergy-service span:not(.bodyenergy-badge) {
            color: #8f8f99;
            font-size: 12px;
        }
        ...
        .bodyenergy-badge--warning {
            border: 1px solid rgba(245, 158, 11, 0.32);
            background: rgba(245, 158, 11, 0.12);
            color: #fcd34d;
        }

        .bodyenergy-badge--neutral {
