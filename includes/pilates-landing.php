...
function bodyenergy_render_pilates_landing()
{
    ...
    /* Platinum final: ritmo compatto e gerarchia coerente con la Home. */
    .be-pilates__hero{min-height:720px;padding:72px 0}
    .be-pilates__hero-layout{grid-template-columns:1.12fr .88fr;gap:64px}
    .be-pilates__hero h1{max-width:760px;font-size:clamp(54px,5.7vw,78px);line-height:.96}
    .be-pilates__lead{max-width:610px;font-size:17px}
    .be-pilates__hero-art-inner{width:min(100%,420px);aspect-ratio:4/4.7}
    .be-pilates__statement{padding:88px 0 54px}
    .be-pilates h2{font-size:clamp(38px,4.2vw,58px)}
    .be-pilates__principles{padding:0 0 88px}
    .be-pilates__principles-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;border-top:0}
    .be-pilates__principles article{display:block;min-height:225px;padding:26px;border:1px solid var(--line);border-radius:16px;background:#111114}
    .be-pilates__principles article>span{display:block;margin-bottom:55px}
    .be-pilates__principles h3{font-size:22px}
    .be-pilates__experience{padding:92px 0}
    .be-pilates__experience-art{min-height:430px}
    .be-pilates__audience{display:none}
    .be-pilates__process{padding:92px 0}
    .be-pilates__section-title{max-width:720px;margin-bottom:44px}
    .be-pilates__process article{min-height:220px}
    .be-pilates__process article>span{margin-bottom:50px}
