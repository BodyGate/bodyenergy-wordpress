            ...
            <div class="be-request__shell">
                ...
                <div class="be-request__layout">
                    <header class="be-request__intro">
                        ...
                        <h1>Parliamo del<br><span>tuo percorso.</span></h1>
                        <p class="be-request__lead">Poche informazioni essenziali per permettere al team Body Energy di ricontattarti nel modo e nella fascia che preferisci.</p>
                        ...
                        <div class="be-request__assurance">
                            ...
                            <p><strong>Contatto personale.</strong><br>La tua richiesta sarà gestita direttamente dal team Body Energy.</p>
                        </div>
                    </header>
                    ...
                    <section class="be-request__panel" aria-label="Modulo richiesta Pilates">
                        ...
                        <form class="be-request__form" onsubmit="return false;">
